...
#define APP_MOTOR_MACHINE_ID "C3"
// Keep the MQTT client id unique so the broker does not disconnect this ESP when another client joins.
#define APP_MOTOR_MQTT_CLIENT_ID "conveyor-C3"
...
// // amr conveyor
// // BTS7960 right/forward PWM input.
// #define MOTOR_RPWM_GPIO GPIO_NUM_6
// // BTS7960 left/reverse PWM input.
// #define MOTOR_LPWM_GPIO GPIO_NUM_7
// // BTS7960 right enable pin.
// #define MOTOR_REN_GPIO GPIO_NUM_15
// // BTS7960 left enable pin.
// #define MOTOR_LEN_GPIO GPIO_NUM_16
// // Upstream conveyor sensor GPIO.
// #define APP_MOTOR_UPSTREAM_SENSOR_PIN 4
// // Downstream conveyor sensor GPIO.
// #define APP_MOTOR_DOWNSTREAM_SENSOR_PIN 5
