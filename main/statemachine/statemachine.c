...
#define STATEMACHINE_RECEIVE_WAIT_TIMEOUT_MS 20000
#define STATEMACHINE_TRAVEL_TIMEOUT_MS 15000
#define STATEMACHINE_HANDOFF_TIMEOUT_MS 15000
#define STATEMACHINE_JOB_TIMEOUT_MS 30000
